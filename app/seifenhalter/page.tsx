...
const product = {
  ...
  name: "Seifenhalter",
  price: 24.99,
  image: "/seifenschale-transparent.png",
  sizes: ["1", "2", "3", "4", "5"],
}

export default function SeifenhalterPage() {
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 rounded-lg bg-[#f3f3f3] transition-colors cursor-pointer group">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="text-[#333333] text-sm font-serif font-semibold">Seifenhalter</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 xl:ml-56">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8 relative">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-serif text-[#000000] leading-tight mb-4">Seifenhalter</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-[#878787] text-sm">
                <div className="flex items-start space-x-2">
                  ...
                  <span>Recyceltes Weinfassholz mit einzigartiger Patina</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="text-green-600 font-semibold">✓</span>
                  <span>Handarbeit aus Eiche – jedes Stück ein Unikat</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="text-green-600 font-semibold">✓</span>
                  <span>Epoxidharz-Versiegelung für wasserfesten Langzeitschutz</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="text-green-600 font-semibold">✓</span>
                  <span>Nachhaltig & robust – perfekt für Bad, Gäste-WC oder als Geschenk</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 text-[#878787] leading-relaxed">
              ...
              <p>
                Ein Stück Geschichte in deinem Badezimmer: Unser handgefertigter Seifenhalter besteht aus recyceltem
                Eichenholz alter Weinfässer. Durch die natürliche Weinlagerung erhält jedes Stück seine individuelle
                Farbgebung – von warmen Rottönen bis zu tiefem Braun.
              </p>
              <p>
                Die Oberfläche ist mit hochwertigem Epoxidharz versiegelt – für dauerhaften Schutz vor Feuchtigkeit und
                eine edle, glänzende Optik. Die offene Lamellenstruktur sorgt für optimale Trocknung deiner Seife –
                hygienisch, langlebig und stilvoll.
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[#878787] text-sm">
                    Recyceltes Eichenholz aus authentischen Weinfässern verschiedener Weingüter
                  </p>
                </div>
              </div>
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[#878787] text-sm">
                    Sorgfältige Handarbeit mit hochwertiger Epoxidharz-Versiegelung
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#f3f3f3] p-4 rounded-lg">
              <p className="text-[#000000] font-semibold text-center">
                Jetzt nachhaltiges Design entdecken – funktional, charaktervoll, einzigartig.
              </p>
            </div>
          </div>
        </div>
